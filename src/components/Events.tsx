      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <p className="text-2xl text-primary font-semibold">Where Potential Meets Opportunity and Greatness Emerges</p>
            <Sparkles className="text-accent animate-pulse" />
          </div>
          <p className="text-lg max-w-3xl mx-auto text-slate-50">🌟 Prepare for an unforgettable experience filled with talent and pure excitement! Our events are designed to make you say, "Sign me up!"</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 lg:mb-16 items-stretch px-2 sm:px-4 lg:px-[10px]">
          ...
          animationDelay: '0.3s'
            ...
            <CardContent className="p-6 flex-1 flex flex-col">
              ...
              <p className="leading-relaxed text-slate-50 flex-1 mb-4">
                💼Step into the world of business mastery with thrilling entrepreneurship challenges, dynamic marketing battles and ground breaking business plan competitions!
              </p>
