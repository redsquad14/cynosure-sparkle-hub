...
const FullWidthSlideshow = () => {
  ...
  return <div className="relative w-full h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden group bg-black z-0" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      {/* Slides Container */}
